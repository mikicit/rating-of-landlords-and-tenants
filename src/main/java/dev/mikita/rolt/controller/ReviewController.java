...
public class ReviewController {
    ...
    public ReviewResponseDTO getReview(@PathVariable Integer id) {
    ...
    public ResponseEntity<Void> addReview(
            Principal principal,
            @RequestBody @Valid ReviewCreateRequestDTO reviewDto) {
        ...
        modelMapper.addMappings(new PropertyMap<ReviewCreateRequestDTO, Review>() {
            @Override
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_MODERATOR')")
    public ResponseEntity<Void> updateReview(@PathVariable Integer id, @RequestBody @Valid ReviewUpdateRequestDTO reviewDto) {
