...
public class PropertyController {
    ...
    public PropertyResponseDTO getProperty(@PathVariable Integer id) {
    ...
    public ResponseEntity<Void> createProperty(Principal principal, @RequestBody @Valid PropertyCreateRequestDTO propertyDto) {
        ...
        final City city = cityService.get(propertyDto.getCityId());
        if (city == null)
    ...
    public void updateProperty(
            ...
            @RequestBody @Valid PropertyUpdateRequestDTO propertyDto) {
