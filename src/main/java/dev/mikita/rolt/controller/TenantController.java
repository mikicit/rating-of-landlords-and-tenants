...
public class TenantController {
    ...
    public ResponseEntity<Void> create(@RequestBody @Valid TenantCreateRequestDTO tenantDto) {
    ...
    public ResponseEntity<Map<String, Object>> getTenants(
        ...
        response.put("tenants", tenants.stream()
                .map(landlord -> modelMapper.map(landlord, TenantResponseDTO.class))
    ...
    public TenantResponseDTO getTenant(@PathVariable Integer id) {
        ...
        return new ModelMapper().map(tenant, TenantResponseDTO.class);
    }
    ...
    public void updateTenant(Principal principal, @PathVariable Integer id, @RequestBody @Valid TenantUpdateRequestDTO tenantDto) {
